            ...
            <div className="container mx-auto my-4 px-4 lg:px-20">
                <div className="my-4 mr-auto w-full rounded-2xl p-8 shadow-2xl md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40">
                    ...
                    <div className="my-2 w-1/2 lg:w-1/4">
                        <button
                            className="focus:shadow-outline w-full rounded-lg bg-primary p-3 text-sm font-bold uppercase tracking-wide 
                ...
                <div className="ml-auto w-full rounded-2xl bg-primary px-8 py-12 lg:-mt-96 lg:w-2/6">
                    <div className="flex flex-col text-white">
                        ...
                        <div className="my-4 flex w-2/3 lg:w-1/2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-white">6600 Uttara RD, Dhaka, BD 24665</p>
                            </div>
                        </div>
                        ...
                        <div className="my-4 flex w-2/3 lg:w-1/2">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="">Tel: 919-898-782</p>
                                <p className="">Fax: 899-778-899</p>
                            </div>
                        </div>
